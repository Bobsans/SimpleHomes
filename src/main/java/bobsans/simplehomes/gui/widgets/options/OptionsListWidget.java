...
public class OptionsListWidget extends AbstractList<OptionsListWidget.Entry> {
    ...
    private OptionsListWidget(ConfigGUI owner, Minecraft minecraft, int width, int height, int top, int bottom, int entryHeight, Runnable diskWriter) {
    ...
    public OptionsListWidget(ConfigGUI owner, Minecraft client, int width, int height, int top, int bottom, int entryHeight) {
    ...
    public void mouseMoved(double x, double y) {
        for (OptionsListWidget.Entry child : this.children()) {
